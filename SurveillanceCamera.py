...
class SurveillanceCamera(Service.Service):
    ...
    def processing_loop(self):
        ...
        while True:
            ...
            self.log('Processed FPS: %0.2f, is_motion=%d, motion_score=%s' % (self.motion_detector.num_frames / time_dur_loop, self.motion_detector.is_recent_motion(), self.motion_detector.score_of_last_motion))
