...
class SurveillanceCamera(Service.Service):
    ...
    def __init__(self):
        ...
        self.frame_recorder = FrameRecorder(base='/mnt/nas/')
    ...
    def processing_loop(self):
        ...
        while True:
            ...
            self.log('Processed FPS: %0.2f, is_motion=%d, motion_score=%s' % (self.motion_detector.num_frames / time_dur_loop, self.motion_detector.is_recent_motion(), str(self.motion_detector.score_of_last_motion)))
